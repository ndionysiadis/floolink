...
<template>
    ...
    >
        ...
        [
          ...
          'rounded-2xl px-4 py-1.5 text-sm font-medium shadow-[inset_0_-8px_10px_#1F2937]',
          'transform-gpu transition-all duration-300 ease-in-out',
          'group-hover:shadow-[inset_0_-6px_10px_#374151]',
          'group-active:shadow-[inset_0_-10px_10px_#374151]',
        ]
      "
        />
